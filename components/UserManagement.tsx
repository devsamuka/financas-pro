...
import { Shield, Mail, Calendar, Key, AlertCircle } from 'lucide-react';
      ...
      <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
          ...
          <div className="text-center md:text-left space-y-1">
            <h3 className="text-2xl font-bold text-slate-800">Minha Conta</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div>
              <p className="text-xs font-bold text-slate-400 uppercase">ID de Usuário (UUID)</p>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-slate-800 font-medium">
                {new Date(user.last_sign_in_at).toLocaleDateString('pt-BR', { dateStyle: 'long' })}
              </p>
            </div>
          </div>
        </div>
